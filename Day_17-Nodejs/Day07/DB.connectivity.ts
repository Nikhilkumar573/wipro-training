...
const uri: string = "mongodb+srv://admin:Ashu%402002@eduprodb.0gv9y9n.mongodb.net/"
...
async function run() {
    ...
    try {
        await client.connect(); //connecting to the MongoDB Atlas cluster or mongoDb compass via local host 
